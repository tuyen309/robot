...
${BROWSER}        Chrome
${leaving_from}   Ha Noi
${Going_to_tc1}    Ho Chi Minh City
${Going_to_tc2}    Da Nang
...
${verify_mess_tc1}    Hanoi (HAN) - Ho Chi... (SGN)
${verify_mess_tc2}    Hanoi (HAN) - Da Nang (DAD)
...
TC1
   ...
   Input Text    xpath=.//input[@placeholder="Where are you going to?"]    ${Going_to_tc1}
   Sleep    2
   ...
   FOR    ${i}    IN RANGE    1    9
        ...
        IF    '${verify_local}' == '${verify_mess_tc1}'
            Log To Console    OK   
        END      
    END
TC2
   ...
   Sleep    5
   Click Element    xpath=.//button[@aria-label="Going to"]
   Input Text    xpath=.//input[@placeholder="Where are you going to?"]    ${Going_to_tc2}
   Sleep    2
      ...
      FOR    ${i}    IN RANGE    ${length_list}-1
         FOR   ${j}    IN RANGE    ${i}+1    ${length_list}
            ...
            IF    '${pricelist_i}' <= '${pricelist_j}'
               IF    '${verify_local}' == '${verify_mess_tc2}'
               Log To Console    OK   
               END   
            END   
         END
